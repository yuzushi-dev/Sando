...
function workspacePath(cwd, relativePath) {
  ...
  if (typeof relativePath !== 'string' || !relativePath || relativePath.length > MAX_PATH_LENGTH || path.isAbsolute(relativePath) || relativePath.includes('\0')) invalid('path must be workspace-relative');
